#!/usr/bin/env python3
"""Compatibility wrapper that forwards Z3 commit fuzzing to the shared harness."""
...
def main() -> int:
    ...
    try:
        ...
        targets = [build_command(args.z3_path, Z3_FLAGS)]
        if args.cvc5_path:
            ensure_command_available(args.cvc5_path, "cvc5")
            targets.append(build_command(args.cvc5_path, CVC5_FLAGS))
