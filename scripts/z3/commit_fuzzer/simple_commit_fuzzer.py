#!/usr/bin/env python3
"""Compatibility wrapper for the contract-driven z3 commit harness."""
...
CONTRACT_PATH = ROOT / "contracts" / "solvers" / "z3.yml"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Compatibility wrapper for the contract-driven z3 commit harness"
    )
    ...
    parser.add_argument("--z3-old-path", required=False)
    parser.add_argument("--cvc4-path", required=False)
    parser.add_argument("--z3-path", default="./build/z3")
