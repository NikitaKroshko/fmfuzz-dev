#!/usr/bin/env python3
"""Run the orchestrator-backed Z3 commit harness."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the orchestrator-backed Z3 commit harness"
    )
    parser.add_argument("--tests-json", required=True)
    parser.add_argument("--job-id")
    parser.add_argument("--tests-root", default="../z3test")
    ...
    ensure_command_available(args.z3_path, "z3")
    ...
    return run_commit_harness(
        ...
        targets=build_z3_cvc5_targets(args.z3_path, args.cvc5_path),
        job_id=args.job_id,
