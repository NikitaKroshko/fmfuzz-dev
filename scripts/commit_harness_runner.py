...
from scripts.commit_harness_orchestrator import CommitHarnessRunner  # noqa: E402
...
def build_command(executable: str, *flags: str) -> str:
...
def run_commit_harness(
    *,
    ...
    harness_template: Sequence[str] | None = None,
) -> int:
